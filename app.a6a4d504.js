...
var client = (0, _algoliasearch.default)('9ALKW0EDLK', 'e26f227f28a5434dd8f751fce0959525');
var index = client.initIndex('elisp-demos');
var $searchBox = document.querySelector('#searchBox input[type=search]');
var $hits = document.querySelector('#hits');

function renderHits(query) {
  index.search(query).then(function (result) {
    // Please sanitize user-provided data when using `innerHTML` to avoid XSS
    $hits.innerHTML = "\n      <ol class=\"ais-hits\">\n        ".concat(result.hits.map(function (hit) {
      return "<li class=\"ais-hits--item\">\n      <article>\n      <h1>".concat(hit._highlightResult.name.value, "</h1>\n      <h5>Example</h5>\n      <p><code>").concat(hit.demo_src, "</code></p>\n      <h5>Result</h5>\n      <p><code>").concat(hit.demo_result, "</code></p>\n      </article>\n      </li>");
    }).join(''), "\n      </ol>");
  });
}
...
renderHits('');
},{"algoliasearch":"node_modules/algoliasearch/dist/algoliasearch.umd.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
